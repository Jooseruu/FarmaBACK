...
public class Database {
    ...
    public static Connection openconnection() {
        ...
        try {
            ...
            connection = DriverManager.getConnection("jdbc:mariadb://localhost:3306/farmacia", "root", "2908"); // Establece una conexión con la base de datos MariaDB en el servidor local
    ...
    // Método para verificar si el correo electrónico y la sesión introducidos coinciden con los de la base de datos
    ...
    // Método para introducir la fecha y la sesión de un doctor
    ...
    // Método para cargar los chips del doctor
